      ...
      if (params.location) {
        ...
        for (var i = 0; i < summary.Countries.length; i++) {
          if (
            ...
            return {
              result: `Total Casos: ${summary.Countries[i].TotalConfirmed}\nTotal Fallecidos: ${summary.Countries[i].TotalDeaths}\nTotal Recuperados: ${summary.Countries[i].TotalRecovered}\n\nFuente: Johns Hopkins CSSE`,
            };
          }
        }
